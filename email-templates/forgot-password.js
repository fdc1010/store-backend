...
**/
  ...
  **/
        ...
        body[override] table.st-Header.st-Header--simplified td.st-Header-logo div.st-Header-area {
          background-image: url('https://www.brdge.tech/images/brdge_logo_grey.png?t=3.61') !important;
        }
        /** */
...
**/
  ...
  **/
  ...
  <body class="st-Email" bgcolor="f6f9fc" style="border: 0; margin: 0; padding: 0; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; min-width: 100%; width: 100%;" override="fix">
                    ...
                    <table class="st-Header st-Header--simplified st-Width st-Width--mobile" border="0" cellpadding="0" cellspacing="0" width="600" style="min-width: 600px;">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="st-Header-logo" align="left" height="75" style="border: 0; margin: 0; padding: 0;">
                            <div class="st-Header-area st-Target st-Target--mobile">
                              <a style="border: 0; margin: 0; padding: 0; text-decoration: none;" href="http://store.backend.fdc">
                                <img alt="Store Backend" border="0" class="st-Header-source" height="75" style="border: 0; margin: 0; padding: 0; color: #6772e5; display: block; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif; font-size: 12px; font-weight: normal;" src="https://api.store.backend/BMart.png">
                              </a>
                            </div>
                          </td>
    ...
    We’ve received a request to reset the password for the Store Backend account associated with {{email}}. No changes have been made to your account yet.
                    ...
                    <table class="st-Copy st-Width st-Width--mobile" border="0" cellpadding="0" cellspacing="0" width="600" style="min-width: 600px;">
                      <tbody>
                        <tr>
                          ...
                          <td class="st-Font st-Font--body" style="border: 0; margin: 0; padding: 0; color: #525F7f !important; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu, sans-serif; font-size: 16px; line-height: 24px;">
                            You can find answers to most questions and get in touch with us at <a style="border: 0; margin: 0; padding: 0; color: #556cd6 !important; text-decoration: none;" href="http://store.backend.fdc">store.backend.fdc</a>. We’re here to help you at any step along the way.
                          </td>
                          <td class="st-Spacer st-Spacer--gutter" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;" width="64">
                            <div class="st-Spacer st-Spacer--filler"> </div>
                          </td>
          ...
          Store Backend, 57 Mohamed Sultan Road, #03-06 Sultan-Link, Singapore 238997
        </span>
                          </td>
                          <td class="st-Spacer st-Spacer--gutter" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;" width="64">
                            <div class="st-Spacer st-Spacer--filler"> </div>
